 ...
 */
#ifndef TESTS_SRC_SHIP_SHIP_CONNECTION_SHIP_MESSAGE_SERIALIZE_BUF_DATA_MATCHER_H
#define TESTS_SRC_SHIP_SHIP_CONNECTION_SHIP_MESSAGE_SERIALIZE_BUF_DATA_MATCHER_H
...
#endif  // TESTS_SRC_SHIP_SHIP_CONNECTION_SHIP_MESSAGE_SERIALIZE_BUF_DATA_MATCHER_H
